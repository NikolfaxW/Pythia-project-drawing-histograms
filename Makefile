...
main23 main95: $(PYTHIA) $$@.cc
	$(CXX) $@.cc -o $@ -w $(CXX_COMMON)

# HEPMC2 or HEPMC3 (use HEPMC3 if both).
main41 main42 main43 main44 main45 main85 main86 main87 main88 main89 main95 main280:\
	$(PYTHIA) $$@.cc
...
# FASTJET3.
main71 main72 main75 main81 main82 main83 main95: $(PYTHIA) $$@.cc
